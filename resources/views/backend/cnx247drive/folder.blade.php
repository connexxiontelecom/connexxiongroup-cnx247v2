        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-block">
                    <h5 class="sub-title">{{ $folder_e[0]->name }}</h5>
...
{{--																						<option value="{{ $folder_e[0]->id }}">{{ $folder_e[0]->name }}</option>--}}

																						<option value="0">None</option>

																						@foreach ($myFolderss as $folder)
        ...
        $(document).on('submit','#fileUploadForm', function(e){
            ...
            var config = {
               ...
               var form_data = new FormData();
                ...
                form_data.append('folder_id', $('#folder_id').val());
