    ...
    <div class="col-xl-9 col-lg-12 pull-xl-3 filter-bar">
        ...
        <div class="row">
            <div class="col-sm-12 filter-bar">
                <div class="card">
                    <div class="card-block">
                        <h5 class="sub-title" id="assignedTask">My Projects</h5>
                        <p class="text-muted">List of all projects created by {{Auth::user()->first_name ?? ''}}</p>
                        <div class="dt-responsive table-responsive">
                            <table id="datatable-task" class="table table-bordered table-striped table-md">
                                <thead>
                                <tr class="text-uppercase">
                ...
                <div class="col-sm-12 filter-bar">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="row">
															<div class="sub-title">Participating</div>
															<div class="dt-responsive table-responsive">
																<table id="datatable-task" class="table table-bordered table-striped table-md">
																		<thead>
																		<tr class="text-uppercase">
																					...
																					@foreach ($task->postParticipants as $participant)
																							@if ($participant->user_id == Auth::user()->id)
																									<tr>
																										...
																										<td>
																											<a href="/activity-stream/profile/{{$task->user->url}}">
																													<img class="img-fluid img-radius" width="30" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{$task->user->first_name}} {{$task->user->surname ?? ''}}" src="/assets/images/avatars/thumbnails/{{ $task->user->avatar ?? '/assets/images/avatar.png' }}" alt="{{$task->user->first_name}} {{$task->user->surname ?? ''}}">
																													<strong style="font-size: xx-small">   {{$task->user->first_name}} {{$task->user->surname ?? ''}} </strong>
																											</a>
																										</td>
																										<td>
                            ...
                            <div class="row">
															<div class="sub-title">Observing</div>
															<div class="dt-responsive table-responsive">
																<table id="datatable-task" class="table table-bordered table-striped table-md">
																		<thead>
																		<tr class="text-uppercase">
