                                            ...
                                            @foreach ($task->responsiblePersons as $person)
                                                ...
                                                @if ($person->user_id == Auth::user()->id)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong class="label label-danger">{{date(Auth::user()->tenant->dateFormat->format ?? 'd F, Y', strtotime($task->created_at) )}} - {{date(Auth::user()->tenant->dateFormat->format ?? 'd F, Y', strtotime($task->end_date) )}}</strong>
