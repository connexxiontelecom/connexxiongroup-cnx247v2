<div class="row">
    <div class="col-md-12">
        <div class="sub-title">Business Trip</div>
            ...
            <div class="tab-pane active" id="expenseReportTab" role="tabpanel">
                 ...
                 <div class="card">
                    <div class="card-header">
                        ...
                        <h5>Business Trip</h5>
                            <span>Use this form to submit a business trip</span>
                    ...
                    <form wire:submit.prevent="submitBusinessTrip">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input wire:model.lazy="destination" type="text" class="form-control form-control-normal" placeholder="Destination">
                                @error('destination')
                                    <span class="mt-3">
                                        <i class="text-danger">{{ $message }}</i>
                                    </span>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                                <textarea wire:model.lazy="purpose" class="form-control form-control-normal" placeholder="Purpose"></textarea>
                                @error('purpose')
                                    <span class="mt-3">
                                        <i class="text-danger">{{ $message }}</i>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <input wire:model.lazy="expense" type="number" class="form-control form-control-normal" placeholder="Expense">
                                @error('expense')
                                    <span class="mt-3">
                                        <i class="text-danger">{{ $message }}</i>
                                    </span>
