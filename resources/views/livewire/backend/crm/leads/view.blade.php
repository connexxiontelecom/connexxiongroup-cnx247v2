        ...
        <div class="col-lg-12 col-xl-12 col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">{{ $lead->client->first_name ?? ''}} {{$lead->client->surname ?? ''}}</h5>
                    <div class="btn-group d-flex justify-content-end">
                        ...
                        <a href="{{route('convert-to-deal', $lead->client->slug)}}" class="btn btn-mini btn-info"><i class="ti-control-shuffle"></i> Convert to Deal</a>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-block">
                                                                        ...
                                                                        <div class="form-group d-flex justify-content-center">
                                                                            <input type="hidden" value="{{$lead->client->id}}" wire:model="client_id">
