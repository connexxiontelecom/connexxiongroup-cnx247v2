								...
								<div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
									<div class="card">
										...
										<div class="card-block post-timelines">
											<div class="chat-header f-w-600">
												<a href="{{route('view-post-activity-stream', $post->post_url)}}">
													<a href="{{route('view-profile', $post->user->url)}}">{{$post->user->first_name ?? ''}} {{$post->user->surname ?? ''}}</a> {<i class="ti-clipboard text-inverse mr-1 ml-1"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Internal memo"></i>} <i class="zmdi zmdi-long-arrow-right text-primary"></i>
